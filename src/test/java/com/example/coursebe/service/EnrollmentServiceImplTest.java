...
public class EnrollmentServiceImplTest {
    ...
    void enrollNonExistentCourse() {
        ...
        // When
        Enrollment result = enrollmentService.enroll(studentId, nonExistentId);
    ...
    void unenroll() {
        ...
        // When
        boolean result = enrollmentService.unenroll(studentId, courseId);
    ...
    void unenrollNonExistentCourse() {
        // Given
        UUID nonExistentId = UUID.randomUUID();
        when(courseRepository.findById(nonExistentId)).thenReturn(Optional.empty());
        
        // When
        boolean result = enrollmentService.unenroll(studentId, nonExistentId);
